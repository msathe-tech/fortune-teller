...
public class FortuneProperties {
	...
	private String fortuneUIURL = "http://fortune-gateway";
	...
	public String getFortuneUIURL() {
		return fortuneUIURL;
	}

	public void setFortuneUIURL(String fortuneUIURL) {
		this.fortuneUIURL = fortuneUIURL;
	}
